 ...
 * @param Decklist* first_half - the decklist which stores the top half cards from the decklist
 * @param Decklist* second_half - the decklist which stores the bottom half cards from the decklist
